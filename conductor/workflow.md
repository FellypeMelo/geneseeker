Below is a **fully revised and expanded `workflow.md`**, deeply integrating:

* Extreme Programming (XP) as a structural foundation
* AI-assisted development (Vibe Coding) with strict guardrails
* Senior-as-Navigator / AI-as-Pilot model
* Stronger TDD enforcement
* Architectural control mechanisms
* Explicit anti–technical debt safeguards
* Controlled AI usage protocol

This is written as a **production-grade engineering operating system**, not just a checklist.
